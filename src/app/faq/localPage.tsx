...
const AnswerTile = ({ answer }: { answer: string | null }): JSX.Element => {
  return (
        <div className={`bg-slate-50 my-5 py-36 px-36 h-32 text-center rounded-lg flex flex-col justify-center ${answer === null ? 'text-gray-400' : ''}`}>
            {answer ?? 'Hover over a question below and your answer will appear here!'}
        </div>
  )
}
