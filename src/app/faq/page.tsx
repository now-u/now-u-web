...
async function FAQPage (): Promise<JSX.Element> {
  ...
  return (
        <>
            ...
            <p className="text-center mb-10 text-3xl">Want to ask something else? <Link className="text-orange hover:underline" href="mailto:hello@now-u.com">Get in Touch</Link></p>
        </>
  )
}
