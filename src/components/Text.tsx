...
export const HeaderText = (props: { text: string }): JSX.Element => {
  return (
    <h1 className="text-5xl pb-3 font-black font-heading"> {props.text} </h1>
  );
};

export const TitleText = (props: { text: string }): JSX.Element => {
  return (
    <h2 className="text-3xl pb-3 font-black font-heading"> {props.text} </h2>
  );
};

export const SubtitleText = (props: { text: string }): JSX.Element => {
  return <p className="lg:text-lg font-subheading">{props.text}</p>;
};
