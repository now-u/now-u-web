...
const mockCauses = [
    {
      ...
      "icon": "ic_getinvolved",
      "name": "Water",
      "description": "Some campaign thing about water with a dog as the photo. Aenean interdum varius ultrices. Ut at egestas lorem. Suspendisse vehicula ex id libero dapibus tempor.",
      "joiners": null,
...
const CauseTile = (props: { cause: Cause }): JSX.Element => {
    return <div className="max-w-sm bg-cream rounded-lg h-full">
        <a href="#">
        ...
        <div className="p-5">
            ...
            <path fill='currentColor'
              ...
              <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">{ props.cause.name }</h5>
            </div>
